...
export const Utama = () => {
  ...
  return (
    <div className="h-screen py-20 px-7 bg-white-A700 flex flex-row">
    {book.map((book) => (
    <div key={book.bookid} className="w-full h-full border-2 border-indigo-600 rounded-lg overflow-auto p-4">
